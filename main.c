 ...
 * File Name: main.c
 *
 * Description: This file contains the starting point of Bluetooth LE BMM350 sensing
 *              service application.
 *
...
/* This function initializes the required BLE ESS & BMM350 task */
                           ...
                           wiced_bt_management_evt_data_t *p_event_data)
{
    ...
    {
        printf("\nThis application implements a custom BMM350 Sensing\n" \
                "Service and sends BMM350 sensor data over BLE\n");
